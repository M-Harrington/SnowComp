  var date_loc = ee.FeatureCollection("users/mrh2182/trainfeat_dateloc");
  ...
  var date_list = ee.FeatureCollection("users/mrh2182/date_list_trainfeat");
  ...
  Export.table.toDrive({
    ...
    description:'sentinel_trainfeat',
    fileFormat: 'CSV'
  });
